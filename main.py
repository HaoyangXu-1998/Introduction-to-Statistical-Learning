...
if __name__ == "__main__":
    ...
    if TASK=="classification":
        ...
        print("model %s param number: %s" % (repr(model),get_parameter_number(model)))
    ...
    print("training dataset size is %d, batch num is %d" % (len(train_dataset),len(train_dataloader)))
    print("valid dataset size is %d, batch num is %d" % (len(valid_dataset),len(valid_dataloader)))
